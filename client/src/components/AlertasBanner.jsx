...
export default function AlertasBanner() {
  ...
  return (
    <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 rounded-lg p-3 flex items-start gap-3">
      ...
      <Link to="/stock/vista" className="text-xs text-yellow-700 dark:text-yellow-300 font-medium hover:underline shrink-0">
        Ver stock
      </Link>
    </div>
  );
