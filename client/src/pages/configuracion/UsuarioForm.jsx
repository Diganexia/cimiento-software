  ...
  return (
    <div className="p-6 max-w-xl">
      <div className="flex items-center gap-3 mb-6">
        <button onClick={() => navigate('/configuracion/usuarios')} className="text-gray-500 hover:text-gray-700">
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
          </svg>
        </button>
        <h1 className="text-xl font-semibold text-gray-800">{esEdicion ? 'Editar usuario' : 'Nuevo usuario'}</h1>
      </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6 mt-4">
          ...
          {showPw && (
            <form onSubmit={handleCambiarPw} className="space-y-3">
              ...
              <div>
                <label className="block text-xs text-gray-600 mb-1">Nueva contraseña (mín. 6 caracteres)</label>
