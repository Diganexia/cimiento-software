...
export default function PuntoVenta() {
  ...
  const handleSubmit = async () => {
    ...
    if (tipoPago !== 'cuenta_corriente' && Math.abs(totalPagado - total) > 0.01) {
      ...
      <div className="p-6 flex items-center justify-center min-h-96">
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8 max-w-md w-full text-center space-y-4">
          ...
          <div className="flex gap-3 justify-center pt-2">
            ...
            <button onClick={() => { setConfirmada(null); setCart([]); setClienteId(''); setObservaciones(''); setDescuentoGlobal(0); }}
      ...
      <div className="flex gap-4 flex-1 min-h-0">
        ...
        <div className="w-72 flex flex-col gap-3">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4 space-y-2">
            ...
            {tipoPago !== 'cuenta_corriente' && (
              <div className={`flex justify-between text-sm ${Math.abs(totalPagado - total) < 0.01 ? 'text-green-600' : 'text-red-500'}`}>
